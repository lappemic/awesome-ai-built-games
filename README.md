...
- [Historical Decision Simulators](https://ordinarymantrying.com/life-simulator-legendary-decisions/) - Step into the real decisions of 11 legendary figures — Buffett, Musk, Jobs, Mandela, Rowling, and more — in biography-driven interactive simulations built with Claude AI.
...
- [Buffett Decision Simulator](https://ordinarymantrying.com/tools/buffett-simulator.html) - Face Warren Buffett's 7 biggest investment decisions before seeing what he chose. Built with Claude AI, single HTML file, no login.
- [Jobs Decision Simulator](https://ordinarymantrying.com/tools/jobs-simulator.html) - Replay Steve Jobs' pivotal decisions — the Apple exile, the NeXT bet, the iPhone launch. Built with Claude AI.
- [Mandela Decision Simulator](https://ordinarymantrying.com/tools/mandela-simulator.html) - Face Nelson Mandela's hardest choices. Built with Claude AI.
- [Marie Curie Decision Simulator](https://ordinarymantrying.com/tools/curie-simulator.html) - Navigate the decisions that shaped the first person to win two Nobel Prizes. Built with Claude AI.
